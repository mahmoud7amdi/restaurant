    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex  m-2 p-2">
                ...
                class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">dinners</a>
            </div>
            <div class="m-2 p-2 bg-slate-200 rounded">
                <div class="spase-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.dinners.update',$dinner->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="sm:col-span-6">
                            <label for="name" class="block text-sm font-medium text-gray-400">Name</label>
                            <div class="mt-1">
                                <input type="text" id="name"  name="name" value="{{ $dinner->name }}"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div>
                                <img class="w-32 h-32 " src="{{ Storage::url($dinner->image) }}" >
                            </div>
                            <div class="mt-1">
