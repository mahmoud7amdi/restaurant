    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex  m-2 p-2">
                ...
                class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Show Beverages</a>
            </div>
            <div class="m-2 p-2 bg-slate-200 rounded">
                <div class="spase-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    
                    <form method="POST" action="{{ route('admin.beverages.store') }}" enctype="multipart/form-data">
                        @csrf
